...
# Linker flags
LDFLAGS := $(LDFLAGS) -Os --gc-sections -z max-page-size=0x1000 -static -nostdlib -n -ostartfiles
...
QEMU ?= $(INFERRED_QEMU)
# Manually added -nographic to run in the Docker
QEMUOPT	= -net none -parallel file:log.txt -nographic
