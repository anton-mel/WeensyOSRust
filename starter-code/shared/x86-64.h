...
#define L1PAGEINDEX(addr)      (pageindex((uintptr_t) (addr), 3))
#define L2PAGEINDEX(addr)      (pageindex((uintptr_t) (addr), 2))
#define L3PAGEINDEX(addr)      (pageindex((uintptr_t) (addr), 1))
#define L4PAGEINDEX(addr)      (pageindex((uintptr_t) (addr), 0))
