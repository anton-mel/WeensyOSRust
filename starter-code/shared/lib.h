...
#define INT_SYS_MAPPING         (INT_SYS + 6)

#define INT_SYS_MEM_TOG         (INT_SYS + 8)
#define INT_SYS_BRK             (INT_SYS + 9)
#define INT_SYS_SBRK            (INT_SYS + 10)
...
#define TEST_PASS()	panic(__FILE__ ": TEST PASS")
